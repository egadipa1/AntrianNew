...
import { EventHandlerUtil, getAttributeValueByBreakpoint, getObjectPropertyValueByKey, stringSnakeToCamel, throttle, } from "../_utils/index";
...
class SwapperComponent {
    ...
    static createInstances = (selector = defaultSwapperQueires.instanseQuery, options = defaultSwapperOptions, queries = defaultSwapperQueires) => {
    ...
    static createInsance = (selector = defaultSwapperQueires.instanseQuery, options = defaultSwapperOptions, queries = defaultSwapperQueires) => {
