import { DataUtil, EventHandlerUtil, getAttributeValueByBreakpoint, getBreakpoint, getObjectPropertyValueByKey, getViewPort, isVisibleElement, stringSnakeToCamel, throttle, } from "../_utils/index";
...
class SearchComponent {
    ...
    static createInstances = (selector = defaultSearchQueires.instanseQuery, options = defaultSearchOptions, queries = defaultSearchQueires) => {
    ...
    static createInsance = (selector = defaultSearchQueires.instanseQuery, options = defaultSearchOptions, queries = defaultSearchQueires) => {
